...
static NEARDATA const char *trap_engravings[TRAPNUM] = {
    ...
    "Здесь был Влад", "ad aerarium", "ad aerarium", (char *) 0, (char *) 0,
    (char *) 0,      (char *) 0,    (char *) 0,    (char *) 0, (char *) 0,
    /* 24..25 */
    (char *) 0, (char *) 0,
};
...
mkgrave(struct mkroom *croom)
{
    ...
    make_grave(m.x, m.y, dobell ? "Спасён звоном колокола!" : (char *) 0);
...
mkinvokearea(void)
{
    ...
    pline("Пол дрожится под вами изнурительно!");
    /* decide whether to issue the crumbling walls message */
    {
        ...
        if (wallct)
            pline("Стены вокруг начинают гнуться и рассыпаться!");
    }
    ...
    You("стоите на краю лестницы вниз!");
...
mk_knox_portal(coordxy x, coordxy y)
{
    ...
    if (!(u.uz.dnum == oracle_level.dnum      /* in main dungeon */
          && !at_dgn_entrance("Квест")    /* but not Quest's entry */
