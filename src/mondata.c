...
msummon_environ(struct permonst *mptr, const char **cloud)
{
    ...
    *cloud = "в облаке"; /* по умолчанию: "in a cloud of <something>" */
    switch (mndx) {
    case PM_WATER_DEMON:
    case PM_AIR_ELEMENTAL:
    case PM_WATER_ELEMENTAL:
    ...
    case PM_SHOCKING_SPHERE:
        *cloud = "в ливне"; /* "shower of sparks" вместо "cloud of..." */
        what = "искр";
        break;
    case PM_EARTH_ELEMENTAL:
    case PM_DUST_VORTEX:
    ...
    case PM_FLAMING_SPHERE:
    /*case PM_SALAMANDER:*/
        *cloud = "в шаре"; /* "ball of flame" вместо "cloud of..." */
        what = "пламени";
        break;
    case PM_ANGEL: /* actually any 'A'-class */
    case PM_YELLOW_LIGHT: /* any 'y'-class */
        *cloud = "во вспышке"; /* "flash of light" вместо "cloud of..." */
        what = "света";
        break;
    default:
        what = "дыма";
