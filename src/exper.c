    ...
    const char *drainer) /* cause of death, if drain should be fatal */
{
    ...
    if (u.ulevel > 1) {
        ...
        livelog_printf(LL_MINORAC, "потер€л %d уровень опыта", u.ulevel + 1);
        ...
        if (u.ulevel > 1)
            ...
            return;
        u.uexp = 0;
        livelog_printf(LL_MINORAC, "потер€л весь опыт");
    }
                   ...
                   *        or wizard mode #levelchange */
{
    ...
    if (u.ulevel < MAXULEV) {
        ...
        ++u.ulevel;
        pline("ƒобро пожаловать %sна уровень опыта %d.",
        ...
        if (count_achievements() == old_ach_cnt)
            livelog_printf(LL_MINORAC, "получил %sуровень опыта %d",
