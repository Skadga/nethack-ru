...
const struct shclass shtypes[] = {
    { "универсальный магазин", NULL,
      ...
      { { 100, RANDOM_CLASS },
        ...
        { 0, 0 } },
      shkgeneral },
    { "торговля подержанной бронёй", "лавка брони",
      ARMOR_CLASS,
      14,
      D_SHOP,
      { { 90, ARMOR_CLASS },
        ...
        { 0, 0 } },
      shkarmors },
    { "букинистический магазин", "лавка свитков",
      SCROLL_CLASS,
      10,
      D_SHOP,
      { { 90, SCROLL_CLASS },
    ...
    { "винная лавка", "лавка зелий",
      ...
      { { 100, POTION_CLASS },
        ...
        { 0, 0 } },
      shkliquors },
    { "антикварная оружейная", "лавка оружия",
      WEAPON_CLASS,
      5,
      D_SHOP,
      { { 90, WEAPON_CLASS },
    ...
    { "ювелирная лавка", "лавка колец",
      ...
      { { 85, RING_CLASS },
        ...
        { 0, 0 } },
      shkrings },
    { "качественная одежда и аксессуары", "лавка жезлов",
      WAND_CLASS,
      3,
      D_SHOP,
      { { 90, WAND_CLASS },
        ...
        { 0, 0 } },
      shkwands },
    { "скобяной магазин", "лавка инструментов",
      TOOL_CLASS,
      3,
      D_SHOP,
      { { 100, TOOL_CLASS },
    ...
    { "редкие книги", "книжный магазин",
      ...
      { { 90, SPBOOK_CLASS },
        ...
        { 0, 0 } },
      shkbooks },
    { "магазин здоровой пищи", "вегетарианская лавка",
      FOOD_CLASS,
      2,
      D_SHOP,
      { { 70, VEGETARIAN_CLASS },
     ...
     * loader.
     */
    { "магазин освещения", "лавка светильников",
      TOOL_CLASS,
      0,
      D_SHOP,
      { { 30, -WAX_CANDLE },
...
mkshobj_at(const struct shclass *shp, int sx, int sy, boolean mkspecl)
{
    ...
    /* 3.6 tribute */
    if (mkspecl && (!strcmp(shp->name, "редкие книги")
                    || !strcmp(shp->name, "букинистический магазин"))) {
...
stock_room(int shp_indx, struct mkroom *sroom)
{
    ...
    if (levl[sx][sy].doormask == D_LOCKED) {
        ...
        if (inside_shop(sx, sy + 1))
            ...
            n++;
        Sprintf(buf, "Закрыто на инвентаризацию");
