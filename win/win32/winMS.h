...
/* unicode stuff */
/* Always use the CP1251 codepage so that the one-byte localized game text
   (Russian build) is converted/interpreted correctly regardless of the
   system ANSI codepage.  The former H_IBM-dependent GetOEMCP() selection
   produced CP866, mangling Cyrillic, and GetACP() fights the system locale. */
#define NH_CODEPAGE 1251
#ifdef _UNICODE
