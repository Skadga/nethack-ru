...
static NEARDATA struct artifact artilist[] = {
    ...
    A("Экскалибур", LONG_SWORD, (SPFX_NOGEN | SPFX_RESTR | SPFX_SEEK
     ...
     */
    A("Мрачный Клык", ORCISH_DAGGER, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAG2),
     ...
     */
    A("Оркрист", ELVEN_BROADSWORD, (SPFX_WARN | SPFX_DFLAG2), 0, M2_ORC,
      PHYS(5, 0), NO_DFNS, NO_CARY, 0, A_CHAOTIC, NON_PM, PM_ELF,
      3, 4, 2000L, CLR_BRIGHT_BLUE, ORCRIST), /* actually light blue */

    A("Жало", ELVEN_DAGGER, (SPFX_WARN | SPFX_DFLAG2), 0, M2_ORC,
      PHYS(5, 0), NO_DFNS, NO_CARY, 0, A_CHAOTIC, NON_PM, PM_ELF,
     ...
     */
    A("Ворпальный Клинок", LONG_SWORD, (SPFX_RESTR | SPFX_BEHEAD), 0, 0,
     ...
     */
    A("Сникерсни", KATANA, SPFX_RESTR, 0, 0, PHYS(0, 8), NO_DFNS, NO_CARY,
    ...
    A("Солнечный Меч", LONG_SWORD, (SPFX_RESTR | SPFX_DFLAG2), 0, M2_UNDEAD,
    ...
    A("Митра Святости", HELM_OF_BRILLIANCE,
    ...
    A("Главный Ключ Воровства", SKELETON_KEY,
    ...
    A("Платиновая Йендорианская Кредитка", CREDIT_CARD,
