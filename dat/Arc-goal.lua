...
-- Objects
des.object({ id = "кристальный ядро", x=50, y=14,buc="blessed",spe=5,name="The Orb of Detection" })
des.object()
des.object()
des.object()
des.object()
...
-- Random monsters.
des.monster("Приспешник of Huhetotl", 50, 14)
des.monster("S")
des.monster("S")
des.monster("S")
des.monster("S")
