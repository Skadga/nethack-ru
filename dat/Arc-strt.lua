...
-- Lord Carnarvon
des.monster({ id = "Лорд Carnarvon", coord = {25, 10}, inventory = function()
   des.object({ id = "федора", spe = 5 });
   des.object({ id = "плеть", spe = 4 });
end })
-- The treasure of Lord Carnarvon
des.object("сундук", 25, 10)
-- student guards for the audience chamber
des.monster("студент", 26, 09)
des.monster("студент", 27, 09)
des.monster("студент", 28, 09)
des.monster("студент", 26, 10)
des.monster("студент", 28, 10)
des.monster("студент", 26, 11)
des.monster("студент", 27, 11)
des.monster("студент", 28, 11)
-- city watch guards in the antechambers
des.monster("сторож", 50, 06)
des.monster("сторож", 50, 14)
-- Eels in the moat
des.monster("гигантский угорь", 20, 10)
des.monster("гигантский угорь", 45, 04)
des.monster("гигантский угорь", 33, 16)
-- Non diggable walls
