...
--
des.object({ id="труп",montype="archeologist" })
des.object({ id="труп",montype="archeologist" })
des.object({ id="труп",montype="barbarian" })
des.object({ id="труп",montype="barbarian" })
des.object({ id="труп",montype="caveman" })
des.object({ id="труп",montype="cavewoman" })
des.object({ id="труп",montype="healer" })
des.object({ id="труп",montype="healer" })
des.object({ id="труп",montype="knight" })
des.object({ id="труп",montype="knight" })
des.object({ id="труп",montype="ranger" })
des.object({ id="труп",montype="ranger" })
des.object({ id="труп",montype="rogue" })
des.object({ id="труп",montype="rogue" })
des.object({ id="труп",montype="samurai" })
des.object({ id="труп",montype="samurai" })
des.object({ id="труп",montype="tourist" })
des.object({ id="труп",montype="tourist" })
des.object({ id="труп",montype="valkyrie" })
des.object({ id="труп",montype="valkyrie" })
des.object({ id="труп",montype="wizard" })
des.object({ id="труп",montype="wizard" })
--
