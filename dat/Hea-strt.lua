...
des.monster({ id = "Hippocrates", coord = {37, 10}, inventory = function()
   des.object({ id = "серебряная кинжал", spe = 5 });
end })
-- The treasure of Hippocrates
des.object("сундук", 37, 10)
-- intern guards for the audience chamber
des.monster("служитель", 29, 08)
des.monster("служитель", 29, 09)
des.monster("служитель", 29, 10)
des.monster("служитель", 29, 11)
des.monster("служитель", 40, 09)
des.monster("служитель", 40, 10)
des.monster("служитель", 40, 11)
des.monster("служитель", 40, 13)
-- Non diggable walls
