...
----------------------------x
   ...
   des.monster({ id = "Волшебник of Yendor", x=16, y=05, asleep=1 })
   des.monster("Адская Гончая", 15, 05)
   des.monster("вампир лорд", 17, 05)
   -- The local treasure
   des.object("Книга Мёртвых", 16, 05)
   -- Surrounding terror
   des.monster("кракен", 14, 02)
   des.monster("гигантский угорь", 17, 02)
   des.monster("кракен", 13, 04)
   des.monster("гигантский угорь", 13, 06)
   des.monster("кракен", 19, 04)
   des.monster("гигантский угорь", 19, 06)
   des.monster("кракен", 15, 08)
   des.monster("гигантский угорь", 17, 08)
   des.monster("пиранья", 15, 02)
   des.monster("пиранья", 19, 08)
   -- Random monsters
   des.monster("D")
   des.monster("H")
   des.monster("&")
