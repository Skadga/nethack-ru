...
des.monster({ id = "Гигантский Мимик", coord = place[2], appear_as = "ter:staircase down" })
des.monster({ id = "Большой Мимик", coord = place[3], appear_as = "ter:staircase down" })
des.monster({ id = "Малый Мимик", coord = place[4], appear_as = "ter:staircase down" })
...
-- Master of Thieves
des.monster({ id = "Повелитель of Thieves", coord = {36, 11}, inventory = function()
   des.object({ id = "кожаная куртка", spe = 5 });
   des.object({ id = "серебряная кинжал", spe = 4 });
   des.object({ id = "кинжал", spe = 2, quantity = d(2,4), buc = "not-cursed" });
end })
-- The treasure of Master of Thieves
des.object("сундук", 36, 11)
-- thug guards, room #1
des.monster("головорез", 28, 10)
des.monster("головорез", 29, 11)
des.monster("головорез", 30, 09)
des.monster("головорез", 31, 07)
-- thug guards, room #2
des.monster("головорез", 31, 13)
des.monster("головорез", 33, 14)
des.monster("головорез", 30, 15)
--thug guards, room #3
des.monster("головорез", 35, 09)
des.monster("головорез", 36, 13)
-- Non diggable walls
...
--
-- West exit
des.monster({ id = "Лепрекон", x=01, y=12, peaceful=0 })
des.monster({ id = "Водяная Нимфа", x=02, y=12, peaceful=0 })
-- North exit
des.monster({ id = "Водяная Нимфа", x=33, y=01, peaceful=0 })
des.monster({ id = "Лепрекон", x=33, y=02, peaceful=0 })
-- East exit
des.monster({ id = "Водяная Нимфа", x=74, y=05, peaceful=0 })
des.monster({ id = "Лепрекон", x=74, y=04, peaceful=0 })
-- South exit
des.monster({ id = "Лепрекон", x=25, y=19, peaceful=0 })
des.monster({ id = "Водяная Нимфа", x=25, y=18, peaceful=0 })
-- Wandering the streets.
for i = 1, math.random(4,7) do
   des.monster({ id = "Водяная Нимфа", coord = streets:rndcoord(1), peaceful=0 })
   des.monster({ id = "Лепрекон", coord = streets:rndcoord(1), peaceful=0 })
end
for i = 1, math.random(7,10) do
   des.monster({ id = "хамелеон", coord = streets:rndcoord(1), peaceful=0 })
end
