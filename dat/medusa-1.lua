...
-- Objects
des.object({ id = "стату€", x=36,y=10, buc="uncursed",
...
-- Random monsters
des.monster({ id = "медуза", x=36,y=10, asleep=1 })
des.monster("гигантский угорь",11,06)
des.monster("гигантский угорь",23,13)
des.monster("гигантский угорь",29,02)
des.monster("медуза",02,02)
des.monster("медуза",00,08)
des.monster("медуза",04,18)
des.monster("вода тролль",51,03)
des.monster("вода тролль",64,11)
