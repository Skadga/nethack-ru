...
des.monster("Гном-Волшебник", 02, 19)
...
des.monster("Гном-Волшебник", 67, 14)
des.object("=", 70, 14)
des.door("locked",69,18)
des.monster("Гном-Лорд", 71, 19)
des.door("locked",73,18)
des.object("сундук", 73, 19)
des.door("locked",50,06)
des.object("(", 50, 03)
des.object({ id = "статуя", x=38, y=15, montype="gnome king", historic=1 })
-- Temple
