...
des.monster("солдат",12,14)
des.monster("солдат",12,13)
des.monster("солдат",11,10)
des.monster("солдат",13,02)
des.monster("солдат",14,03)
des.monster("солдат",20,02)
des.monster("солдат",30,02)
des.monster("солдат",40,02)
des.monster("солдат",30,16)
des.monster("солдат",32,16)
des.monster("солдат",40,16)
des.monster("солдат",54,16)
des.monster("солдат",54,14)
des.monster("солдат",54,13)
des.monster("солдат",57,10)
des.monster("солдат",57,09)
des.monster("лейтенант",15,08)
-- Possible source of a boulder
des.monster("Каменный Гигант",03,01)
...
des.monster("D",33,14)
-- Eels in the moat
des.monster("гигантский угорь",17,08)
des.monster("гигантский угорь",17,11)
des.monster("гигантский угорь",48,08)
des.monster("гигантский угорь",48,11)
-- The corner rooms treasures
des.object("алмаз",19,06)
des.object("алмаз",20,06)
des.object("алмаз",21,06)
des.object("изумруд",19,13)
des.object("изумруд",20,13)
des.object("изумруд",21,13)
des.object("рубин",46,06)
des.object("рубин",47,06)
des.object("рубин",48,06)
des.object("аметист",46,13)
des.object("аметист",47,13)
des.object("аметист",48,13)
