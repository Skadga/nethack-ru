...
des.monster({ id = "Norn", coord = {35, 10}, inventory = function()
   des.object({ id = "полосатая кольчуга", spe = 5 });
   des.object({ id = "длинный меч", spe = 4 });
end })
-- The treasure of the Norn
des.object("сундук", 36, 10)
-- valkyrie guards for the audience chamber
des.monster("воин", 27, 08)
des.monster("воин", 27, 09)
des.monster("воин", 27, 11)
des.monster("воин", 27, 12)
des.monster("воин", 42, 08)
des.monster("воин", 42, 09)
des.monster("воин", 42, 11)
des.monster("воин", 42, 12)
-- Non diggable walls
...
des.monster("Огненный Муравей", 04, 12)
des.monster("Огненный Муравей", 08, 08)
des.monster("Огненный Муравей", 14, 04)
des.monster("Огненный Муравей", 17, 11)
des.monster("Огненный Муравей", 24, 10)
des.monster("Огненный Муравей", 45, 10)
des.monster("Огненный Муравей", 54, 02)
des.monster("Огненный Муравей", 55, 07)
des.monster("Огненный Муравей", 58, 14)
des.monster("Огненный Муравей", 63, 17)
des.monster({ id = "Огненный Гигант", x=18, y=01, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=10, y=16, peaceful = 0 })
