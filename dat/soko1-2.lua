...
des.object("валун",02,06);
des.object("валун",03,06);
des.object("валун",04,07);
des.object("валун",05,07);
des.object("валун",02,08);
des.object("валун",05,08);
des.object("валун",03,09);
des.object("валун",04,09);
des.object("валун",03,10);
des.object("валун",05,10);
des.object("валун",06,12);
--
des.object("валун",07,14);
--
des.object("валун",11,05);
des.object("валун",12,06);
des.object("валун",10,07);
des.object("валун",11,07);
des.object("валун",10,08);
des.object("валун",12,09);
des.object("валун",11,10);
...
des.monster({ id = "√игантский ћимик", appear_as = "obj:валун" });
des.monster({ id = "√игантский ћимик", appear_as = "obj:валун" });
...
if percent(25) then
   des.object({ id="сумка хранени€", coord=pt,
		buc="not-cursed", achievement=1 });
else
   des.object({ id="амулет отражени€", coord=pt,
		buc="not-cursed", achievement=1 });
end
des.engraving({ coord = pt, type = "burn", text = "Elbereth" });
des.object({ id = "запугивание монстра", coord = pt, buc = "cursed" });
