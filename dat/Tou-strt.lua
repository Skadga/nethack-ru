...
des.monster({ id = "Twoflower", coord = {64, 03}, inventory = function()
   des.object({ id = "низкие сапоги", spe = 3 });
   des.object({ id = "Гавайская рубашка", spe = 3 });
end })
-- The treasure of Twoflower
des.object("сундук", 64, 03)
-- guides for the audience chamber
des.monster("проводник", 29, 03)
des.monster("проводник", 32, 04)
des.monster("проводник", 35, 02)
des.monster("проводник", 38, 03)
des.monster("проводник", 45, 03)
des.monster("проводник", 48, 02)
des.monster("проводник", 49, 04)
des.monster("проводник", 51, 03)
des.monster("проводник", 57, 03)
des.monster("проводник", 62, 04)
des.monster("проводник", 66, 04)
-- path guards
des.monster("сторож", 35, 08)
des.monster("сторож", 36, 08)
-- river monsters
des.monster("гигантский угорь", 62, 12)
des.monster("пиранья", 47, 10)
des.monster("пиранья", 29, 11)
des.monster("кракен", 34, 09)
des.monster("кракен", 37, 09)
-- Random traps
des.trap()
des.trap()
des.trap()
