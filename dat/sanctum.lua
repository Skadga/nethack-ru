...
des.object("?")
-- Some monsters.
des.monster({ id = "рогатый дьявол", x=14,y=12,peaceful=0 })
des.monster({ id = "шипастый дьявол", x=18,y=08,peaceful=0 })
des.monster({ id = "эриния", x=10,y=04,peaceful=0 })
des.monster({ id = "марилит", x=07,y=09,peaceful=0 })
des.monster({ id = "налфешни", x=27,y=08,peaceful=0 })
-- Moloch's horde
des.monster({ id = "priest", x=20,y=03,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=15,y=04,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=11,y=05,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=11,y=07,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=11,y=09,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=11,y=12,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=15,y=13,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=17,y=13,align="noalign",peaceful=0 })
des.monster({ id = "priest", x=21,y=13,align="noalign",peaceful=0 })
-- A few nasties
des.monster("L")
des.monster("L")
des.monster("V")
