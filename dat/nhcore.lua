...
function mk_dgl_extrainfo()
    if ((prev_dgl_extrainfo == 0) or (prev_dgl_extrainfo + 50 < u.moves)) then
        ...
        if extrai then
            ...
            if dname == "Форт Лудиос" then
                dstr = "Knx";
                sortval = sortval + 245;
            elseif dname == "Квест" then
                dstr = "Q" .. u.dlevel;
                sortval = sortval + 250 + u.dlevel;
            elseif dname == "Стихийные планы" then
                dstr = "End";
                sortval = sortval + 256;
            elseif dname == "Башня Влада" then
                dstr = "T" .. u.dlevel;
                sortval = sortval + 235 + u.depth;
            elseif dname == "Сокобан" then
                dstr = "S" .. u.dlevel;
                sortval = sortval + 225 + u.depth;
            elseif dname == "Гномьи шахты" then
                dstr = "M" .. u.dlevel;
