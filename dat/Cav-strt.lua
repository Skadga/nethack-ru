...
des.monster({ id = "Shaman Karnov", coord = {35, 02}, inventory = function()
   ...
   des.object({ id = "дубинка", spe = 5 });
end })
-- The treasure of Shaman Karnov
des.object("сундук", 34, 02)
-- neanderthal guards for the audience chamber
des.monster("неандерталец", 20, 03)
des.monster("неандерталец", 20, 02)
des.monster("неандерталец", 20, 01)
des.monster("неандерталец", 21, 03)
des.monster("неандерталец", 21, 02)
des.monster("неандерталец", 21, 01)
des.monster("неандерталец", 22, 01)
des.monster("неандерталец", 26, 09)
-- Non diggable walls
...
des.monster({ id ="бугбеар", x=47, y=02, peaceful=0 })
des.monster({ id ="бугбеар", x=48, y=03, peaceful=0 })
des.monster({ id ="бугбеар", x=49, y=04, peaceful=0 })
des.monster({ id ="бугбеар", x=67, y=03, peaceful=0 })
des.monster({ id ="бугбеар", x=69, y=04, peaceful=0 })
des.monster({ id ="бугбеар", x=51, y=13, peaceful=0 })
des.monster({ id ="бугбеар", x=53, y=14, peaceful=0 })
des.monster({ id ="бугбеар", x=55, y=15, peaceful=0 })
des.monster({ id ="бугбеар", x=63, y=10, peaceful=0 })
des.monster({ id ="бугбеар", x=65, y=09, peaceful=0 })
des.monster({ id ="бугбеар", x=67, y=10, peaceful=0 })
des.monster({ id ="бугбеар", x=69, y=11, peaceful=0 })
des.wallify()
