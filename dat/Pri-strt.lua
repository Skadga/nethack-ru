...
-- High Priest
des.monster({ id = "Арх Priest", coord = {28, 10}, inventory = function()
   des.object({ id = "ряса", spe = 4 });
   des.object({ id = "булава", spe = 4 });
end })
-- The treasure of High Priest
des.object("сундук", 27, 10)
-- knight guards for the audience chamber
des.monster("послушник", 32, 07)
des.monster("послушник", 32, 08)
des.monster("послушник", 32, 11)
des.monster("послушник", 32, 12)
des.monster("послушник", 33, 07)
des.monster("послушник", 33, 08)
des.monster("послушник", 33, 11)
des.monster("послушник", 33, 12)
-- Non diggable walls
...
for i = 1, 12 do
   des.monster("человеческий зомби", spacelocs:rndcoord(1));
end
