...
des.monster({ id = "Neferet the зелёный", coord = {23, 05}, inventory = function()
   des.object({ id = "эльфийский плащ", spe = 5 });
   des.object({ id = "цеп", spe = 5 });
end })
-- The treasure of the quest leader
des.object("сундук", 24, 05)
-- apprentice guards for the audience chamber
des.monster("подмастерье", 30, 07)
des.monster("подмастерье", 24, 06)
des.monster("подмастерье", 15, 06)
des.monster("подмастерье", 15, 12)
des.monster("подмастерье", 26, 11)
des.monster("подмастерье", 27, 11)
des.monster("подмастерье", 19, 09)
des.monster("подмастерье", 20, 09)
-- Eels in the pond
des.monster("гигантский угорь", 62, 14)
des.monster("гигантский угорь", 69, 15)
des.monster("гигантский угорь", 67, 17)
-- Non diggable walls
