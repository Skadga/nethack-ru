...
.|....|.......|......|....|....|.............
   ...
   -- Wall "ruins"
   des.object("валун",19,02)
   des.object("валун",20,02)
   des.object("валун",21,02)
   des.object("валун",36,02)
   des.object("валун",36,03)
   des.object("валун",06,04)
   des.object("валун",05,05)
   des.object("валун",06,05)
   des.object("валун",07,05)
   des.object("валун",39,05)
   des.object("валун",08,08)
   des.object("валун",09,08)
   des.object("валун",10,08)
   des.object("валун",11,08)
   des.object("валун",06,10)
   des.object("валун",05,11)
   des.object("валун",06,11)
   des.object("валун",07,11)
   des.object("валун",21,11)
   des.object("валун",21,12)
   des.object("валун",13,13)
   des.object("валун",14,13)
   des.object("валун",15,13)
   des.object("валун",14,14)
   -- Doors
   ...
   if math.random(0, 1) == 1 then
      des.object("магический маркер")
   else
      des.object("магический лампа")
   end
   -- The resident nasty
   des.monster("Orcus",33,15)
   -- And its preferred companions
   des.monster("человеческий зомби",32,15)
   des.monster("тень",32,14)
   des.monster("тень",32,16)
   des.monster("вампир",35,16)
   des.monster("вампир",35,14)
   des.monster("вампир лорд",36,14)
   des.monster("вампир лорд",36,15)
   -- Randomly placed companions
   des.monster("скелетный")
   des.monster("скелетный")
   des.monster("скелетный")
   des.monster("скелетный")
   des.monster("скелетный")
   ...
   des.monster("тень")
   des.monster("тень")
   des.monster("гигантский зомби")
   des.monster("гигантский зомби")
   des.monster("гигантский зомби")
   des.monster("эттин зомби")
   des.monster("эттин зомби")
   des.monster("эттин зомби")
   des.monster("человеческий зомби")
   des.monster("человеческий зомби")
   des.monster("человеческий зомби")
   des.monster("вампир")
   des.monster("вампир")
   des.monster("вампир")
   des.monster("вампир лорд")
   des.monster("вампир лорд")
