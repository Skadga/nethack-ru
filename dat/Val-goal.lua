...
-- Objects
des.object({ id = "кристальный ядро", x=17, y=08, buc="blessed", spe=5, name="The Orb of Fate" })
des.object()
des.object()
des.object()
des.object()
...
des.trap()
-- Random monsters.
des.monster("Лорд Surtur", 17, 08)
des.monster("Огненный Муравей")
des.monster("Огненный Муравей")
des.monster("Огненный Муравей")
des.monster("Огненный Муравей")
des.monster("a")
des.monster("a")
des.monster({ id = "Огненный Гигант", x=10, y=06, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=10, y=07, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=10, y=08, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=10, y=09, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=10, y=10, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=24, y=06, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=24, y=07, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=24, y=08, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=24, y=09, peaceful = 0 })
des.monster({ id = "Огненный Гигант", x=24, y=10, peaceful = 0 })
des.monster({ id = "Огненный Гигант", peaceful = 0 })
des.monster({ id = "Огненный Гигант", peaceful = 0 })
