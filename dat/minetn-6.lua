...
des.monster("гном")
des.monster("гном")
des.monster("гном", 14, 8)
des.monster("Гном-Лорд", 14, 7)
des.monster("гном", 27, 10)
des.monster("Гном-Лорд")
des.monster("Гном-Лорд")
des.monster("дварф")
des.monster("дварф")
des.monster("дварф")
des.monster({ id = "дварф", peaceful = 1 })
des.monster({ id = "дварф", peaceful = 1 })
des.monster({ id = "гном", peaceful = 1 })
des.monster({ id = "гном", peaceful = 1 })
des.monster({ id = "Хоббит", peaceful = 1 })
des.monster({ id = "Гоблин", peaceful = 1 })
des.monster({ id = "кобольд", peaceful = 1 })
des.monster({ id = "собачье", peaceful = 1 })
des.monster({ id = "сторож", peaceful = 1 })
des.monster({ id = "сторож", peaceful = 1 })
des.monster({ id = "сторож", peaceful = 1 })
des.monster({ id = "стража капитан", peaceful = 1 })
des.monster({ id = "стража капитан", peaceful = 1 })
