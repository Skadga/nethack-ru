...
des.object({ id = "сундук", trapped = 0, locked = 1, coord = loc ,
             contents = function()
                des.object("wishing");
                des.object("прирост уровня");
             end
});
-- Prevent monsters from eating it.  (@'s never eat objects)
des.engraving({ coord = loc, type="burn", text="Elbereth" })
des.object({ id = "запугивание монстра", coord = loc, buc="cursed" })
-- The treasure of the lord
des.object("сундук",37,08)
-- Traps
...
des.monster("солдат",08,06)
des.monster("солдат",09,05)
des.monster("солдат",11,05)
des.monster("солдат",12,06)
des.monster("солдат",08,10)
des.monster("солдат",09,11)
des.monster("солдат",11,11)
des.monster("солдат",12,10)
des.monster("лейтенант",09,08)
-- Soldiers guarding the towers
des.monster("солдат",03,02)
des.monster("солдат",05,02)
des.monster("солдат",57,02)
des.monster("солдат",59,02)
des.monster("солдат",03,14)
des.monster("солдат",05,14)
des.monster("солдат",57,14)
des.monster("солдат",59,14)
...
des.monster("гигантский угорь",05,07)
des.monster("гигантский угорь",05,09)
des.monster("гигантский угорь",57,07)
des.monster("гигантский угорь",57,09)
des.monster("акула",05,00)
des.monster("акула",05,16)
des.monster("акула",57,00)
des.monster("акула",57,16)
