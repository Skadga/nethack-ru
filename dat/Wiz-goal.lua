...
-- Objects
des.object({ id = "амулет ясновидения", x=16, y=11, buc="blessed", spe=0, name="The Eye of the Aethiopica" })
des.object()
des.object()
des.object()
des.object()
...
des.monster({ class = "i",random, peaceful = 0 })
des.monster({ class = "i",random, peaceful = 0 })
des.monster("Летучая Мышь-Вампир")
des.monster("Летучая Мышь-Вампир")
des.monster("Летучая Мышь-Вампир")
des.monster("Летучая Мышь-Вампир")
des.monster("Летучая Мышь-Вампир")
...
des.monster({ id = "плут", x=35, y=06, peaceful=1, name="Pug" })
des.monster({ id = "совомедведь", x=47, y=06, peaceful=1, asleep=1 })
des.monster({ id = "волшебник", x=32, y=11, peaceful=1, asleep=1, name="Newt" })
des.monster({ id = "Серый-эльф", x=44, y=11, peaceful=1 })
des.monster({ id = "Холмовой Гигант", x=47, y=11, peaceful=1, asleep=1 })
des.monster({ id = "Гном-Волшебник", x=38, y=06, peaceful=1 })
des.monster({ id = "заключённый", x=35, y=11, peaceful=1 })
des.monster({ id = "заключённый", x=41, y=11, peaceful=1, asleep=1 })
