...
des.door("open",59,17)
-- Objects
des.object({ id = "кредитная карта", x=04, y=01, buc="blessed", spe=0, name="The Platinum Yendorian Express Card" })
des.object()
des.object()
des.object()
des.object()
...
-- Random monsters.
des.monster({ id = "Повелитель of Thieves", x=04, y=01, peaceful = 0 })
des.monster("Гигантский Паук")
des.monster("Гигантский Паук")
des.monster("Гигантский Паук")
des.monster("Гигантский Паук")
des.monster("Гигантский Паук")
...
des.monster("incubus", 02, 08)
des.monster("incubus", 08, 08)
...
des.monster({ id = "Капитан Коп", x=24, y=09, peaceful = 0 })
des.monster({ id = "Лейтенант Коп", x=20, y=09, peaceful = 0 })
des.monster({ id = "Лейтенант Коп", x=22, y=11, peaceful = 0 })
des.monster({ id = "Лейтенант Коп", x=22, y=07, peaceful = 0 })
des.monster({ id = "Коп Ключевой", x=19, y=07, peaceful = 0 })
des.monster({ id = "Коп Ключевой", x=19, y=08, peaceful = 0 })
des.monster({ id = "Коп Ключевой", x=22, y=09, peaceful = 0 })
des.monster({ id = "Коп Ключевой", x=24, y=11, peaceful = 0 })
des.monster({ id = "Коп Ключевой", x=19, y=11, peaceful = 0 })
des.monster("заключённый", 19, 13)
des.monster("заключённый", 21, 13)
des.monster("заключённый", 24, 13)
--
des.monster({ id = "сторож", x=33, y=10, peaceful = 0 })
