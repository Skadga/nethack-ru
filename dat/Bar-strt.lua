...
des.monster({ id = "Pelias", coord = {10, 07}, inventory = function()
   des.object({ id = "рунический меч", spe = 5 });
   des.object({ id = "цепная кольчуга", spe = 5 });
end })
-- The treasure of Pelias
des.object("сундук", 09, 05)
-- chieftain guards for the audience chamber
des.monster("вождь", 10, 05)
des.monster("вождь", 10, 09)
des.monster("вождь", 11, 05)
des.monster("вождь", 11, 09)
des.monster("вождь", 14, 05)
des.monster("вождь", 14, 09)
des.monster("вождь", 16, 05)
des.monster("вождь", 16, 09)
-- Non diggable walls
des.non_diggable(selection.area(00,00,75,19))
-- One trap to keep the ogres at bay.
des.trap("spiked pit",37,07)
-- Eels in the river
des.monster("гигантский угорь", 36, 01)
des.monster("гигантский угорь", 37, 09)
des.monster("гигантский угорь", 39, 15)
-- Monsters on siege duty.
local ogrelocs = selection.floodfill(37,7) & selection.area(40,03, 45,20)
for i = 0, 11 do
   des.monster({ id = "огр", coord = ogrelocs:rndcoord(1), peaceful = 0 })
end
