...
-- Objects
des.object({ id = "зеркало", x=50,y=06, buc="blessed", spe=0, name="The Magic Mirror of Merlin" })
...
des.monster({ id = " вазит", peaceful=0 })
des.monster({ id = " вазит", peaceful=0 })
des.monster({ id = " вазит", peaceful=0 })
des.monster({ id = " вазит", peaceful=0 })
des.monster({ id = " вазит", peaceful=0 })
...
des.monster({ class = "i", peaceful=0 })
des.monster({ id = "ќхристое ∆еле", peaceful=0 })
des.monster({ id = "ќхристое ∆еле", peaceful=0 })
des.monster({ id = "ќхристое ∆еле", peaceful=0 })
des.monster({ id = "ќхристое ∆еле", peaceful=0 })
des.monster({ id = "ќхристое ∆еле", peaceful=0 })
