...
des.room({ type = "ordinary", lit=1, x=3,y=3, xalign="center",yalign="center", w=11,h=9, contents = function()
              des.object({ id = "стату€", x = 0, y = 0, montype = "C", historic = true });
              des.object({ id = "стату€", x = 0, y = 8, montype = "C", historic = true });
              des.object({ id = "стату€", x =10, y = 0, montype = "C", historic = true });
              des.object({ id = "стату€", x =10, y = 8, montype = "C", historic = true });
              des.object({ id = "стату€", x = 5, y = 1, montype = "C", historic = true });
              des.object({ id = "стату€", x = 5, y = 7, montype = "C", historic = true });
              des.object({ id = "стату€", x = 2, y = 4, montype = "C", historic = true });
              des.object({ id = "стату€", x = 8, y = 4, montype = "C", historic = true });
