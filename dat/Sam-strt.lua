...
-- Lord Sato
des.monster({ id = "Лорд Sato", coord = {20, 04}, inventory = function()
   des.object({ id = "ленточная кольчуга", spe = 5, eroded=-1, buc="not-cursed" });
   des.object({ id = "катана", spe = 4, eroded=-1, buc="not-cursed" });
end })
-- The treasure of Lord Sato
des.object("сундук", 20, 04)
...
des.monster({ id = "ниндзя", x=64, y=00, peaceful=0 })
des.monster("волк", 65, 01)
des.monster({ id = "ниндзя", x=67, y=02, peaceful=0 })
des.monster({ id = "ниндзя", x=69, y=05, peaceful=0 })
des.monster({ id = "ниндзя", x=69, y=06, peaceful=0 })
des.monster("волк", 69, 07)
des.monster({ id = "ниндзя", x=70, y=06, peaceful=0 })
des.monster({ id = "ниндзя", x=70, y=07, peaceful=0 })
des.monster({ id = "ниндзя", x=72, y=01, peaceful=0 })
des.monster("волк", 75, 09)
des.monster({ id = "ниндзя", x=73, y=05, peaceful=0 })
des.monster({ id = "ниндзя", x=68, y=02, peaceful=0 })
